  ...
  const uploadImage = async (file) => {
    ...
    reader.onload = async () => {
      ...
      if (userData) {
        ...
        try {
          const docRef = doc(db, "doctors", userData.uid); // Corrected collection name
        ...
        <div className="container">
          <div className="profile-info-content">
            ...
            <div className="profile-info-item infos">
              ...
              <p className="profile-info-infos specialization"><b>Specialization:</b> {userData.specialization}</p>
              {userData.specializationType === 'specialist' && (
                <p className="profile-info-infos subSpecialization"><b>Sub-Specialization:</b> {userData.subSpecialization}</p>
              )}
              <p className="profile-info-infos phoneNumber"><b>Number of Patient:</b> {userData.numberOfPatients}</p>
